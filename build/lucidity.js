...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'lucidity.data';
      var REMOTE_PACKAGE_BASE = 'lucidity.data';
...
Module['FS_createPath']("/src", "images", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_lucidity.data');

      };
      Module['addRunDependency']('datafile_lucidity.data');
...
var wasmBinaryFile = 'lucidity.wasm';
